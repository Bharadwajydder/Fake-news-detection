# -*- coding: utf-8 -*-
"""
Created on Wed Mar  4 12:07:24 2020
...
Ktrain, Ktest, Btrain, Btest = train_test_split(kbr['text'].values.astype('U'), z, test_size=0.20, random_state=0)
...
url ="https://www.washingtonpost.com/politics/biden-calls-for-federal-civil-rights-investigation-into-death-of-george-floyd/2020/05/27/33d7c8a8-a02e-11ea-b5c9-570a91917d8d_story.html"
...
#-------------------------------------------FINDING FAKE OR REAL USING MULTINOMIAL NB COUNT VECTORIZIER------------------------------------#
...
#-------------------------------------FINDING FAKE OR REAL USING MULTINOMIAL NB TFIDF VECTORIZIER-------------------------------------------#
...
#-----------------------------------FINDING FAKE OR REAL USING PASSIVE AGGRESSIVE CLASSIFIER  TFIDF VECTORIZIER-----------------------------#
...
#------------------------------------FINDING FAKE OR REAL USING PASSIVE AGGRESSIVE CLASSIFIER  HASH VECTORIZIER------------------------------#
...
#--------------------------------------FINDING FAKE OR REAL USING  XGBOOST COUNT VECTORIZIER-------------------------------------------------#
count_test2 = count_vectorizer.transform([text])

Alg2.fit(count_train, Btrain)

pred5 = Alg.predict(count_test2)
#--------------------------------------FINDING FAKE OR REAL USING  XGBOOST TFIDF VECTORIZIER-------------------------------------------------#
tfidf_test2 = tfidf_vectorizer.transform([text])
